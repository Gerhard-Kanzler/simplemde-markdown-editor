...
function linkModal( editor ) {
	...
	var closeButton = document.getElementsByClassName('simple-mde-modal-close')[0];
...
/**
 * Toggle side by side preview / Full screen
 */
...
function togglePreview(editor) {
	...
	var result = mdIt.render(editor.value());
	...
	// if there is no preview container
